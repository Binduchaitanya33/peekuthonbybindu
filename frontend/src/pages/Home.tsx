  ...
  const testimonials = [
    {
      ...
      text: 'CareerGPS helped me land my dream job at a top tech company. The mentor connections were invaluable!',
    },
    {
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-foreground/80 mb-8">
              Join thousands of professionals who have found their dream jobs with CareerGPS
            </p>
            <Link
              to="/signup"
